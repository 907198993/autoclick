...
public class EaseCommonUtils {
     ...
     * @return
     */
    public static EMMessage createCardMessage(String storeDesc,String storeName,String storeAvatar,String userName){
        EMMessage message = EMMessage.createTxtSendMessage(storeDesc, userName);
        message.setAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE,EaseConstant.MESSAGE_BUSINESS_CARD);
        message.setAttribute(EaseConstant.MESSAGE_BUSINESS_CARD_DESC,storeDesc);
        message.setAttribute(EaseConstant.MESSAGE_BUSINESS_CARD_NAME,storeName);
        message.setAttribute(EaseConstant.MESSAGE_BUSINESS_CARD_AVATAR,storeAvatar);
        return message;
    }
     ...
     */
    public static void copyText(Context context, String text, boolean showTip) {
