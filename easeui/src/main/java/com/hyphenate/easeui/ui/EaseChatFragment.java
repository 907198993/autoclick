...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public static final int ITEM_TAKE_PICTURE = 1;  //图片
    public static final int ITEM_PICTURE = 2;       //拍照
    public static final int ITEM_LOCATION = 3;      //位置
    public static final int ITEM_GIFT = 4;
    public static final int ITEM_VOICE_CALL = 5;
    public static final int ITEM_VIDEO_CALL = 6;
    public static final int ITEM_USER_CARD = 7;
    public static final int ITEM_VIDEO = 8;         //视频
    public static final int ITEM_CARD = 10;         //名片
    public static final int ITEM_PRODUCT = 11;      //产品
    protected int[] itemStrings = {R.string.attach_picture, R.string.attach_take_pic, R.string.attach_take_video, R.string.attach_location,
            R.string.attach_take_card, R.string.attach_take_product};
    protected int[] itemdrawables = {R.drawable.icon_pic, R.drawable.icon_paizhao, R.drawable.icon_vedio, R.drawable.icon_weizhi,
            R.drawable.icon_card, R.drawable.icon_product};
    protected int[] itemIds = {ITEM_PICTURE, ITEM_TAKE_PICTURE, ITEM_VIDEO, ITEM_LOCATION, ITEM_CARD, ITEM_PRODUCT};
    ...
    private String storeName;       //名片商家名字
    private String storeAvatar;       //名片商家头像
    private String storeDesc;       //名片商家详情
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        storeDesc = fragmentArgs.getString(EaseConstant.MESSAGE_BUSINESS_CARD_DESC);
        storeAvatar = fragmentArgs.getString(EaseConstant.MESSAGE_BUSINESS_CARD_AVATAR);
        storeName = fragmentArgs.getString(EaseConstant.MESSAGE_BUSINESS_CARD_NAME);
        backHome = fragmentArgs.getBoolean("backHome", false);
...
//        messageList.setAvatarShape(1);
        ...
        inputMenu.setChatInputMenuListener(new ChatInputMenuListener() {
            ...
            public boolean onPressToSpeakBtnTouch(View v, MotionEvent event) {
                //EaseChatFragmentPermissionsDispatcher.recordAudioWithCheck(EaseChatFragment.this, v, event);
                return true;
            }
        ...
        EMMessage message = EMMessage.createTxtSendMessage("联系方式", toChatUsername);
    }
    ...
    protected void setUpView() {
            ...
            public void onClick(View v) {
                if (backHome) {
                    if (chatFragmentHelper != null) {
                        chatFragmentHelper.onLeftImageClick();
                    }
                } else {
                    onBackPressed();
                }
        ...
        titleBar.setRightImageResource(R.drawable.icon_more_s);
        titleBar.setRightLayoutClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (chatFragmentHelper != null) {
                    chatFragmentHelper.onRightImageClick(toChatUsername);
                }
            }
        });
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        for (EMMessage message : messages) {
            ...
            if (EaseUtils.getIntergerSF(getActivity(), toChatUsername, 1) == 1) {
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_LOCATION:
                    ...
                    break;
                case ITEM_CARD:
                    //sendCardMessage(storeDesc,storeName,storeAvatar);
                    break;
                case ITEM_PRODUCT:
                    break;
                default:
    ...
    protected void sendCardMessage(String storeDesc, String storeName, String storeAvatar) {
        EMMessage message = EaseCommonUtils.createCardMessage(storeDesc, storeName, storeAvatar, toChatUsername);
        sendMessage(message);
    }
    ...
    public interface EaseChatFragmentHelper {
        ...
        void onRightImageClick(String username);
  ...
  /*  @OnShowRationale({Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA})
    void showRationaleSelectPicFromCamera(final PermissionRequest request) {
        Toast.makeText(getActivity(), "该功能需要相机，储存卡读写权限", Toast.LENGTH_SHORT).show();
        request.proceed();
    }

    //权限被拒绝
    @OnPermissionDenied({Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA})
    void showDeniedForSelectPicFromCamera() {
    ...
    void showNeverAskForSelectPicFromCamera() {
        Toast.makeText(getActivity(), "该功能没有权限，请到设置页面开启相机，储存卡读写权限", Toast.LENGTH_SHORT).show();
    }


    @OnShowRationale(Manifest.permission.WRITE_EXTERNAL_STORAGE)
    void showRationaleSelectPicFromLocal(final PermissionRequest request) {
        Toast.makeText(getActivity(), "该功能需要储存卡读写权限", Toast.LENGTH_SHORT).show();
        request.proceed();
    }

    //权限被拒绝
    @OnPermissionDenied(Manifest.permission.WRITE_EXTERNAL_STORAGE)
    void showDeniedForSelectPicFromLocal() {
        Toast.makeText(getActivity(), "你拒绝了这个权限", Toast.LENGTH_SHORT).show();
    }

    //用户勾选了不再询问且被拒
    @OnNeverAskAgain(Manifest.permission.WRITE_EXTERNAL_STORAGE)
    void showNeverAskForSelectPicFromLocal() {
        Toast.makeText(getActivity(), "该功能没有权限，请到设置页面开启储存卡读写权限", Toast.LENGTH_SHORT).show();
    }
    ...
    void showRationaleOpenLocation(final PermissionRequest request) {
        Toast.makeText(getActivity(), "该功能需要定位权限", Toast.LENGTH_SHORT).show();
        request.proceed();
    }

    //权限被拒绝
    @OnPermissionDenied(Manifest.permission.ACCESS_COARSE_LOCATION)
    void showDeniedForOpenLocation() {
        Toast.makeText(getActivity(), "你拒绝了这个权限", Toast.LENGTH_SHORT).show();
    }

    //用户勾选了不再询问且被拒
    @OnNeverAskAgain(Manifest.permission.ACCESS_COARSE_LOCATION)
    void showNeverAskForOpenLocation() {
        Toast.makeText(getActivity(), "该功能没有权限，请到设置页面开启定位权限", Toast.LENGTH_SHORT).show();
    }


    @NeedsPermission({Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO})
    void recordAudio(View v, MotionEvent event) {
        voiceRecorderView.onPressToSpeakBtnTouch(v, event, new EaseVoiceRecorderCallback() {
    ...
    void showRationaleRecordAudio(final PermissionRequest request) {
        Toast.makeText(getActivity(), "该功能需要读写,录音权限", Toast.LENGTH_SHORT).show();
        request.proceed();
    }
    ...
    void showNeverAskForRecordAudio() {
        Toast.makeText(getActivity(), "该功能没有权限，请到设置页面开启读写,录音权限", Toast.LENGTH_SHORT).show();
    }*/
