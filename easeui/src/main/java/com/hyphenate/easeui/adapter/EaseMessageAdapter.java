...
import com.hyphenate.easeui.widget.presenter.EaseChatContactPresenter;
...
import com.hyphenate.easeui.widget.presenter.EaseChatWantProductPresenter;
...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    private static final int MESSAGE_TYPE_SENT_BUSINESS_CARD = 14;
    private static final int MESSAGE_TYPE_RECV_BUSINESS_CARD = 15;

    private static final int MESSAGE_TYPE_SENT_PRODUCT = 16;
    private static final int MESSAGE_TYPE_RECV_PRODUCT = 17;

    private static final int MESSAGE_TYPE_SENT_CONTACT = 18;
    private static final int MESSAGE_TYPE_RECV_CONTACT = 19;
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getType() == EMMessage.Type.TXT) {
            ...
            if (message.getStringAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE, "").equals(EaseConstant.MESSAGE_BUSINESS_CARD)) {
                return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_BUSINESS_CARD : MESSAGE_TYPE_SENT_BUSINESS_CARD;
            }
            if (message.getStringAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE, "").equals(EaseConstant.MESSAGE_PRODUCT)) {
                return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_PRODUCT : MESSAGE_TYPE_SENT_PRODUCT;
            }
            if (message.getStringAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE, "").equals(EaseConstant.MESSAGE_BUSINESS_CONTACT)) {
                return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_CONTACT : MESSAGE_TYPE_SENT_CONTACT;
            }
            if (message.getStringAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE, "").equals(EaseConstant.MESSAGE_WANT_PROCUCT)) {
                return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_PRODUCT : MESSAGE_TYPE_SENT_PRODUCT;
            }
    ...
    protected EaseChatRowPresenter createChatRowPresenter(EMMessage message, int position) {
        ...
        switch (message.getType()) {
            case TXT:
                ...
                } else if (message.getStringAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE, "").equals(EaseConstant.MESSAGE_BUSINESS_CARD)) {
                    presenter = new EaseChatBusinessCardPresenter();
                } else if (message.getStringAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE, "").equals(EaseConstant.MESSAGE_PRODUCT)) {
                    presenter = new EaseChatProductPresenter();
                } else if (message.getStringAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE, "").equals(EaseConstant.MESSAGE_BUSINESS_CONTACT)) {
                    presenter = new EaseChatContactPresenter();
                } else if (message.getStringAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE, "").equals(EaseConstant.MESSAGE_WANT_PROCUCT)) {
                    presenter = new EaseChatWantProductPresenter();
                } else {
            ...
            case FILE:
                ...
                break;
            case IMAGE:
                presenter = new EaseChatImagePresenter(messages);
                break;
            case VOICE:
