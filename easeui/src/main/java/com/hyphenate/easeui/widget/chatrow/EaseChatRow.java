...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if (message.getStringAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE, "").equals(EaseConstant.MESSAGE_BUSINESS_CONTACT)) {
                EaseUserUtils.setUserAvatar(context, message.getTo(), userAvatarView);
                EaseUserUtils.setUserNick(message.getTo(), usernickView);
            } else if (message.direct() == Direct.SEND) { //商家回复消息
        ...
        if (userAvatarView != null) {
            userAvatarView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (itemClickListener != null) {
                        if (message.getStringAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE, "").equals(EaseConstant.MESSAGE_BUSINESS_CONTACT)) {
                            itemClickListener.onUserAvatarClick(message.getTo());
            ...
            userAvatarView.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    if (itemClickListener != null) {
                        if (message.getStringAttribute(EaseConstant.MESSAGE_CUSTOM_TYPE, "").equals(EaseConstant.MESSAGE_BUSINESS_CONTACT)) {
                            itemClickListener.onUserAvatarLongClick(message.getTo());
                        } else if (message.direct() == Direct.SEND) {
